...
data = data.loc[:, ~data.columns.isin(['Id', 'Idade', 'Tecnica', 'Passe'])] #exclui as colunas id e idade da base jogadores pre carregada
...
validacao = validacao.loc[:, ~validacao.columns.isin(['Id', 'Idade', 'Tecnica', 'Passe'])]  #exclui as colunas id e idade
...
jog_desconhecidos = pd.read_csv('Jog_Desconhecidos.csv')
print("Jogadores Desconhecidos")
print(jog_desconhecidos['Classe'].value_counts())  
